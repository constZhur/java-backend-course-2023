...
public class UserChat extends TableImpl<UserChatRecord> {
    ...
    /**
     * The column <code>USER_CHAT.NAME</code>.
     */
    public final TableField<UserChatRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");
